...
@Disabled
@Deprecated
@Autonomous(name = "Upper Score Preload Warehouse Park Red", group = "red", preselectTeleOp = "Red TeleOp")
public class UpperScorePreloadWarehouseParkRed extends LinearOpMode
{
    @Override
