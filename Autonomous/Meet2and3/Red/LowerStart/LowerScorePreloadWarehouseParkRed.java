...
@Autonomous(name = "Lower Score Preload Warehouse Park Red", group = "red", preselectTeleOp = "Red TeleOp")
public class LowerScorePreloadWarehouseParkRed extends LinearOpMode
{
    @Override
    public void runOpMode() throws InterruptedException
    {
        ...
        drive.gyroTurn(100.0);
        drive.gyroDrive(-98.5, 100.0);
