...
@Autonomous(name = "Lower Warehouse Park Red", group = "red", preselectTeleOp = "Red TeleOp")
public class LowerWarehouseParkRed extends LinearOpMode
{
    @Override
