...
//    public static double MAX_ANGLE = 10; // radians
//
//    public static PIDCoefficients PID = new PIDCoefficients(0,0,0);
//
//    public static double MAX_VEL = Math.toRadians(22.5); // radians per second
//    public static double MAX_ACCEL = Math.toRadians(22.5); // radians per seconds squared
//    public static double MAX_JERK = Math.toRadians(22.5); // radians per seconds cubed
//
...
//
//        // if necessary, reverse the motor so CCW (counter clockwise) is positive
